 ...
 * @author Fabrizio
 */
public class DialogEditarReservaAutoparte extends JDialog {
    ...
    private DAOReservaServDos daorsd = new DAOReservaServDosIMPLEMENT();

    public DialogEditarReservaAutoparte(JFrame parent, int idReservaActual, String estadoActual, String fechaActual) {
        super(parent, "Modificar Reserva de Autoparte", true);
    ...
    private void guardarCambios() {
        try {
            ...
            daorsd.modificarEstadoYFecha(idReserva, nuevoEstado, nuevaFecha);
